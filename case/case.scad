...
layout_back_offset=[165*layout_printmode,(outer_upper_height+outer_lower_height)*layout_printmode,outer_rear_depth*layout_printmode];
layout_slider_rotate=[0,270*layout_printmode,0];
layout_slider_offset=[180*layout_printmode,120*layout_printmode,-slider_offset[0]*layout_printmode];


//slider
translate(layout_slider_offset)
rotate(layout_slider_rotate)
union () {
...
//front piece
translate(layout_front_offset)
rotate(layout_front_rotate)
union () {
  color("yellow")
  difference () {
      union () {
...
//back piece
translate(layout_back_offset)
rotate(layout_back_rotate)
union () {
...
//TODO fix hole for screwdriver holder